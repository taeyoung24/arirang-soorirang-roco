...
| 이름 | 역할 | 상세 내용 |
| :--- | :--- | :--- |
| [정태영](https://github.com/taeyoung24) | 팀장, 디자인 및 프론트엔드 | 전체 프로젝트 리딩 및 UI/UX 디자인, 프론트엔드 개발 |
| [신동빈](https://github.com/dobi02) | AI파트 리더 | 음성 인식 및 발음 분석 모델 연구 및 구현 총괄 |
| [이재민](https://github.com/jmsb02) | 백엔드 리더 | API 서버 설계 및 비즈니스 로직 구현, DB 관리 |
| [바야스갈랑](https://github.com/atg0dd) | AI파트 개발 | 프론트엔드 개발 및 AI 파트 전환 개발 |
