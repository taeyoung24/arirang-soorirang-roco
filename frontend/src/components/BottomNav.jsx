  ...
  return (
    <div className="fixed bottom-13 left-1/2 -translate-x-1/2 z-50">
      <div 
        ...
        className="BottomNav w-48 h-11 px-6 bg-yellow-primary rounded-[32px] outline outline-[2.40px] outline-offset-[-1.20px] outline-text inline-flex justify-center items-center gap-6 overflow-hidden"
      >
        {/* House Icon */}
        <div data-layer="Navigation / House_01" className="relative cursor-pointer transition-transform active:scale-90">
        ...
        {/* Play Icon */}
        <div data-layer="Media / Play" className="relative cursor-pointer transition-transform active:scale-90">
          <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* Heart Icon */}
        <div data-layer="Interface / Heart_02" className="relative cursor-pointer transition-transform active:scale-90">
          <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
