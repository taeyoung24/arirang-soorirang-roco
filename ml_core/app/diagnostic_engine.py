...
class DiagnosticEngine:
    ...
    SLOW_SPEECH_DURATION_RATIO = 2.7
    VERY_SLOW_SPEECH_DURATION_RATIO = 3.4
    STRETCHED_SYLLABLE_DURATION_RATIO = 2.4
    STRETCHED_SYLLABLE_DELTA_MS = 220
    STRETCHED_WORD_DURATION_RATIO = 2.35
    STRETCHED_WORD_DELTA_MS = 650
    VERY_STRETCHED_DURATION_RATIO = 3.6
    VERY_STRETCHED_DELTA_MS = 450
    MEDIUM_INTERIOR_PAUSE_MS = 700
    HIGH_INTERIOR_PAUSE_MS = 1500
